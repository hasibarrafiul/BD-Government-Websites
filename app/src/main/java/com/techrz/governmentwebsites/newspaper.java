...
public class newspaper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b1= findViewById(R.id.news1);

        b1.setOnClickListener(v -> {
            homeActivity.link ="https://www.dpp.gov.bd/bgpress";
            Intent i=new Intent(newspaper.this,webview.class);
            startActivity(i);
            if (mInterstitialAd != null) {
                mInterstitialAd.show(newspaper.this);
            } else {
