...
public class Literature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b1= findViewById(R.id.lit1);
        Button b2= findViewById(R.id.lit2);
        ...
        mAdView = findViewById(R.id.adViewlit);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        b1.setOnClickListener(v -> {
            homeActivity.link ="https://www.banglaacademy.gov.bd";
            Intent i=new Intent(Literature.this,webview.class);
            startActivity(i);
            if (mInterstitialAd != null) {
                mInterstitialAd.show(Literature.this);
            } else {
        ...
        b2.setOnClickListener(v -> {
            homeActivity.link ="https://www.nanl.gov.bd";
            Intent i=new Intent(Literature.this,webview.class);
            startActivity(i);
            if (mInterstitialAd != null) {
                mInterstitialAd.show(Literature.this);
