...
public class Technology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b1= findViewById(R.id.tech1);
        Button b2= findViewById(R.id.tech2);



        b1.setOnClickListener(v -> {
            homeActivity.link ="https://bcc.gov.bd";
            Intent i=new Intent(Technology.this,webview.class);
            startActivity(i);
            if (mInterstitialAd != null) {
                mInterstitialAd.show(Technology.this);
            } else {
        ...
        b2.setOnClickListener(v -> {
            homeActivity.link ="https://most.gov.bd";
            Intent i=new Intent(Technology.this,webview.class);
            startActivity(i);
            if (mInterstitialAd != null) {
                mInterstitialAd.show(Technology.this);
